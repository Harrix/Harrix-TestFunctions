...
\label{TestFunctions:section:HML_TestFunction_HyperEllipsoid}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_HyperEllipsoid. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_HyperEllipsoid}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_HyperEllipsoide} нас \pageref{TestFunctions:img:HML_TestFunction_HyperEllipsoide} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_HyperEllipsoid}
  \caption{Гипер-эллипсоид} 
  \label{TestFunctions:img:HML_TestFunction_HyperEllipsoide}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_HyperEllipsoid]
