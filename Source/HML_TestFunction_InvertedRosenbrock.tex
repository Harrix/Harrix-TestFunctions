...
\label{TestFunctions:section:HML_TestFunction_InvertedRosenbrock}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_InvertedRosenbrock. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_InvertedRosenbrock}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_InvertedRosenbrocke} нас \pageref{TestFunctions:img:HML_TestFunction_InvertedRosenbrocke} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_InvertedRosenbrock}
  \caption{Перевернутая функция Розенброка} 
  \label{TestFunctions:img:HML_TestFunction_InvertedRosenbrocke}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_InvertedRosenbrock]
