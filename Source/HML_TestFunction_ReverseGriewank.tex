...
\label{TestFunctions:section:HML_TestFunction_ReverseGriewank}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_ReverseGriewank. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_ReverseGriewank}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_ReverseGriewanke} нас \pageref{TestFunctions:img:HML_TestFunction_ReverseGriewanke} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_ReverseGriewank}
  \caption{Функция ReverseGriewank} 
  \label{TestFunctions:img:HML_TestFunction_ReverseGriewanke}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_ReverseGriewank]
