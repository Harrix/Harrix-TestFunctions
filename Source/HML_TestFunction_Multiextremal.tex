...
\label{TestFunctions:section:HML_TestFunction_Multiextremal}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_Multiextremal. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_Multiextremal}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Multiextremale} нас \pageref{TestFunctions:img:HML_TestFunction_Multiextremale} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=1] {HML_TestFunction_Multiextremal}
  \caption{Функция Multiextremal} 
  \label{TestFunctions:img:HML_TestFunction_Multiextremale}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_Multiextremal]
