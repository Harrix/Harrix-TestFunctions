...
\label{TestFunctions:section:HML_TestFunction_RastriginWithChange}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_RastriginWithChange. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_RastriginWithChange}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_RastriginWithChangee} нас \pageref{TestFunctions:img:HML_TestFunction_RastriginWithChangee} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_RastriginWithChange}
  \caption{Функция Растригина с изменением коэффициентов} 
  \label{TestFunctions:img:HML_TestFunction_RastriginWithChangee}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_RastriginWithChange]
