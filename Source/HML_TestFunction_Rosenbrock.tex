...
\label{TestFunctions:section:HML_TestFunction_Rosenbrock}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_Rosenbrock. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_Rosenbrock}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Rosenbrock} нас \pageref{TestFunctions:img:HML_TestFunction_Rosenbrock} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Rosenbrock}
  \caption{Функция Розенброка} 
  \label{TestFunctions:img:HML_TestFunction_Rosenbrock}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_Rosenbrock]
