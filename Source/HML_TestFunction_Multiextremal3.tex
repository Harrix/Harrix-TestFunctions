...
\label{TestFunctions:section:HML_TestFunction_Multiextremal3}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_Multiextremal3. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_Multiextremal3}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Multiextremal3e} нас \pageref{TestFunctions:img:HML_TestFunction_Multiextremal3e} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Multiextremal3}
  \caption{Функция Multiextremal3} 
  \label{TestFunctions:img:HML_TestFunction_Multiextremal3e}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_Multiextremal3]
