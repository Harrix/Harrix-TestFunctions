...
\begin{tabularwide}
\textbf{Идентификатор:} & MHL\_TestFuction\_ParaboloidOfRevolution. \\
...
\textbf{Формула} (целевая функция):
\begin{equation}
\label{TestFunctions:eq:MHL_TestFuction_ParaboloidOfRevolution}
...
\textbf{Точка минимума:} & $\bar{x}_{min}={\left( 0,0,\ldots,0\right)}^\mathrm{T} $, то есть $\left(\bar{x}_{min} \right)_j=0$ ($j=\overline{1,n}$).    \\
\textbf{Минимум функции:} & $f\left(\bar{x}_{min} \right) =0$.   \\
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFuction_ParaboloidOfRevolution} нас \pageref{TestFunctions:img:MHL_TestFuction_ParaboloidOfRevolution} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFuction_ParaboloidOfRevolution}
  \caption{Эллиптический параболоид} 
  \label{TestFunctions:img:MHL_TestFuction_ParaboloidOfRevolution}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции MHL\_TestFuction\_ParaboloidOfRevolution]
...
\begin{tabularwide}
\textbf{Идентификатор:} & MHL\_TestFuction\_Rastrigin. \\
...
\textbf{Формула} (целевая функция):
\begin{equation}
\label{TestFunctions:eq:MHL_TestFuction_Rastrigin}
...
\textbf{Точка минимума:} & $\bar{x}_{min}={\left( 0,0,\ldots,0\right)}^\mathrm{T} $, то есть $\left(\bar{x}_{min} \right)_j=0$ ($j=\overline{1,n}$).    \\
\textbf{Минимум функции:} & $f\left(\bar{x}_{min} \right) =0$.   \\
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFuction_Rastrigin} нас \pageref{TestFunctions:img:MHL_TestFuction_Rastrigin} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFuction_Rastrigin}
  \caption{Функция Растригина} 
  \label{TestFunctions:img:MHL_TestFuction_Rastrigin}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции MHL\_TestFuction\_Rastrigin]
...
\textbf{Минимум функции:} & $f\left(\bar{x}_{min} \right) =0$.   \\
\textbf{График:} & Рисунок \ref{TestFunctions:img:MHL_TestFuction_Rosenbrock} нас \pageref{TestFunctions:img:MHL_TestFuction_Rosenbrock} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {MHL_TestFuction_Rosenbrock}
  \caption{Функция Розенброка} 
  \label{TestFunctions:img:MHL_TestFuction_Rosenbrock}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции MHL\_TestFuction\_Rosenbrock]
