...
\label{TestFunctions:section:HML_TestFunction_RotatedHyperEllipsoid}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_RotatedHyperEllipsoid. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_RotatedHyperEllipsoid}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_RotatedHyperEllipsoide} нас \pageref{TestFunctions:img:HML_TestFunction_RotatedHyperEllipsoide} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_RotatedHyperEllipsoid}
  \caption{Развернутый гипер-эллипсоид} 
  \label{TestFunctions:img:HML_TestFunction_RotatedHyperEllipsoide}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_RotatedHyperEllipsoid]
...
\begin{equation*}
\label{TestFunctions:eq:HML_RotatedHyperEllipsoidError}
