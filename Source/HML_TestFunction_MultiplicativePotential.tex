...
\label{TestFunctions:section:HML_TestFunction_MultiplicativePotential}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_MultiplicativePotential. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_MultiplicativePotential}
f\left( \bar{x}\right) = -z\left( \bar{x}_1\right)\cdot z\left( \bar{x}_2\right), \text{ где}
\end{equation}
\begin{equation*}
\label{TestFunctions:eq:HML_MultiplicativePotential2}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_MultiplicativePotentiale} нас \pageref{TestFunctions:img:HML_TestFunction_MultiplicativePotentiale} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_MultiplicativePotential}
  \caption{Мультипликативная потенциальная функция} 
  \label{TestFunctions:img:HML_TestFunction_MultiplicativePotentiale}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_MultiplicativePotential]
