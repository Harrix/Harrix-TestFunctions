...
\label{TestFunctions:section:HML_TestFunction_Rastrigin}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_Rastrigin. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_Rastrigin}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Rastrigin} нас \pageref{TestFunctions:img:HML_TestFunction_Rastrigin} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Rastrigin}
  \caption{Функция Растригина} 
  \label{TestFunctions:img:HML_TestFunction_Rastrigin}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_Rastrigin]
