...
\label{TestFunctions:section:HML_TestFunction_Katnikov}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_Katnikov. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_Katnikov}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Katnikove} нас \pageref{TestFunctions:img:HML_TestFunction_Katnikove} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Katnikov}
  \caption{Функция Катникова} 
  \label{TestFunctions:img:HML_TestFunction_Katnikove}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_Katnikov]
