...
\label{TestFunctions:section:HML_TestFunction_AdditivePotential}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_AdditivePotential. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_AdditivePotential}
f\left( \bar{x}\right) = z\left( \bar{x}_1\right)+ z\left( \bar{x}_2\right), \text{ где}
\end{equation}
\begin{equation*}
\label{TestFunctions:eq:HML_AdditivePotential2}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_AdditivePotentiale} нас \pageref{TestFunctions:img:HML_TestFunction_AdditivePotentiale} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_AdditivePotential}
  \caption{Аддитивная потенциальная функция} 
  \label{TestFunctions:img:HML_TestFunction_AdditivePotentiale}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_AdditivePotential]
