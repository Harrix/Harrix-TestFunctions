...
\label{TestFunctions:section:HML_TestFunction_Sombrero}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_Sombrero. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_Sombrero}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_Sombreroe} нас \pageref{TestFunctions:img:HML_TestFunction_Sombreroe} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_Sombrero}
  \caption{Функция Сомбреро} 
  \label{TestFunctions:img:HML_TestFunction_Sombreroe}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_Sombrero]
