\section {Функция Растригина новгородская}
\label{TestFunctions:section:HML_TestFunction_RastriginNovgorod}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_RastriginNovgorod. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_RastriginNovgorod}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_RastriginNovgorode} нас \pageref{TestFunctions:img:HML_TestFunction_RastriginNovgorode} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_RastriginNovgorod}
  \caption{Функция Растригина новгородская} 
  \label{TestFunctions:img:HML_TestFunction_RastriginNovgorode}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_RastriginNovgorod]
...
Данная функция проскочила в переписке с Василием Рябовым (\href{mailto:varjag84@mail.ru}{varjag84@mail.ru}) из Нижнего Новгорода.
