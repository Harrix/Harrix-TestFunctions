...
\label{TestFunctions:section:HML_TestFunction_ParaboloidOfRevolution}
\subsection {Описание функции}

\begin{tabularwide}
\textbf{Идентификатор:} & HML\_TestFunction\_ParaboloidOfRevolution. \\
...
\begin{equation}
\label{TestFunctions:eq:HML_TestFunction_ParaboloidOfRevolution}
...
\textbf{График:} & Рисунок \ref{TestFunctions:img:HML_TestFunction_ParaboloidOfRevolution} нас \pageref{TestFunctions:img:HML_TestFunction_ParaboloidOfRevolution} стр.   \\
\end{tabularwide}

\begin{figure} [h] 
  \center
  \includegraphics [scale=0.5] {HML_TestFunction_ParaboloidOfRevolution}
  \caption{Эллиптический параболоид} 
  \label{TestFunctions:img:HML_TestFunction_ParaboloidOfRevolution}  
\end{figure}
...
\begin{lstlisting}[caption=Код функции HML\_TestFunction\_ParaboloidOfRevolution]
